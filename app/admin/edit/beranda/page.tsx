...
export default function EditBeranda() {
  ...
  const [formData, setFormData] = useState({
    ...
    news: [
      { title: "Program Pembangunan Infrastruktur 2024", date: "15 November 2024" },
      ...
      <div className="bg-white shadow-md border-b">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Edit Halaman Beranda</h1>
              <p className="text-gray-600 text-sm">Kelola konten halaman utama</p>
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-800">Statistik Desa</h2>
              ...
              <div className="space-y-4">
                {formData.stats.map((stat, index) => (
                  <div key={index} className="flex gap-3 items-start p-4 border-2 border-gray-100 rounded-lg hover:border-green-200 transition-colors">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-800">Berita & Kegiatan</h2>
                <button className="flex items-center gap-2 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors">
                  <FaPlus />
                  Tambah
                </button>
              ...
              <div className="space-y-4">
                {formData.news.map((item, index) => (
                  <div key={index} className="p-4 border-2 border-gray-100 rounded-lg hover:border-green-200 transition-colors">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl shadow-lg p-6 border border-blue-200">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Pastikan semua informasi sudah benar sebelum menyimpan. Klik Preview untuk melihat hasil.
              </p>
            </div>
          </div>
        </div>
